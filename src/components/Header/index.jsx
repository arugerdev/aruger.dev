        ...
        <header className='header'>
            ...
            <section className='headerNavegationSection'>
                <ul className='headerButtonsNav'>
                    ...
                    <li className='headerButtonsNavItem'>
                        <Link onClick={() => { buttonClickAudio.play() }} to='/projects' className={'headerButton' + ('/projects' === route ? ' active' : '')}>Projects</Link>
                    </li>
                    <li className='headerButtonsNavItem'>
                        <Link onClick={() => { buttonClickAudio.play() }} to='/about' className={'headerButton' + ('/about' === route ? ' active' : '')}>About</Link>
                    </li>
                </ul>
            </section>
